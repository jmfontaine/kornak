...
class Kornak_Uri_Http extends Zend_Uri_Http
{
    /**
    ...
    public static function fromString($uri)
    {
        ...
        if (in_array($scheme, array('http', 'https')) === false) {
            ...
            throw new Kornak_Uri_Exception("Invalid scheme: '$scheme'");
        }

        $schemeHandler = new Kornak_Uri_Http($scheme, $schemeSpecific);
    ...
    {
        if (!$this->valid()) {
            throw new Kornak_Uri_Domain_Exception("Invalid URI '$this->_uri'");
        }
    ...
    public function getSpecificLevelDomain($level)
    {
        ...
        if ($level > $count) {
            throw new Kornak_Uri_Http_Exception('Invalid level');
        }
